        ...
        <div className="profile-modal">
            <article className="br3 ba b--black-10 mv4 w-100 w-50-m w-25-l mw6 shadow-5 center bg-white">
                ...
                <img
                    ...
                    <label className="mg2 fw6" htmlFor="user-name">Name:</label>
                    <input
                    ...
                    <label className="mg2 fw6" htmlFor="user-age">Age:</label>
                    <input
                    onChange={this.onFormChange}
                    className="pa2 ba w-100"
                    ...
                    <label className="mg2 fw6" htmlFor="user-name">Pet:</label>
                    <input
                    onChange={this.onFormChange}
                    className="pa2 ba w-100"
